...
public class Renderer {
    ...
    private static final int IMMEDIATE_RENDERER = 1;
    /** The indicator for vertex array based rendering */
    private static final int VERTEX_ARRAY_RENDERER = 2;

    /** The indicator for direct GL line renderer (the default) */
    private static final int DEFAULT_LINE_STRIP_RENDERER = 3;
    /** The indicator for consistant quad based lines */
    private static final int QUAD_BASED_LINE_STRIP_RENDERER = 4;
     ...
     */
    private static void setLineStripRenderer(LineStripRenderer renderer) {
     ...
     */
    private static void setRenderer(SGL r) {
        renderer = r;
    }
